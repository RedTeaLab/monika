 ...
 */
export function SetTrayManager(tm: $models.TrayManager | null): $CancellablePromise<void> {
 ...
 */
export function CancelPopupHide(): $CancellablePromise<void> {
    return $Call.ByName("monika/internal/api.App.CancelPopupHide");
}

/**
 * SchedulePopupHide starts a debounce to hide the popup.
 */
export function SchedulePopupHide(): $CancellablePromise<void> {
    return $Call.ByName("monika/internal/api.App.SchedulePopupHide");
}
