      ...
      <div key={node.path}>
        <div
          ...
          style={{
            ...
            paddingRight: '6px',
            color: gColor || ((isDirSelected || isFileSelected || isContexted) ? 'var(--text-primary)' : 'var(--text-secondary)'),
            background: (isDirSelected || isFileSelected || isContexted) ? 'var(--bg-active)' : 'transparent',
          }}
