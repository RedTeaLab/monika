...
function StatusBar({ showConsole, showFileTree, onToggleConsole, onToggleFileTree }: StatusBarProps) {
  ...
  return (
    <div className="flex items-center h-[22px] text-[12px] select-none border-t border-[var(--border)]">
      <div className="flex items-center h-full px-2 bg-[var(--bg-statusbar)] text-white gap-1">
      ...
      <div className="flex items-center h-full px-3 bg-[#68217a] text-white gap-2">
        ...
        <span className="opacity-70">tok: {tokenCount}</span>
      </div>
    </div>
  )
}
